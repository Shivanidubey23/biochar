...
ROOT_URLCONF = 'biochar_project.urls'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@biochar.com')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@biochar.com')
